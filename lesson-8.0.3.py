...
class Exception:
    ...
    def my_input(self):
        while True:
            try:
                val = int(input('Введите целое число и нажмите Enter для добавления в список - '))
                self.my_list.append(val)
                print(f'Текущий список - {self.my_list} \n ')
            except:
                print(f"Недопустимое значение! Введите целое число")
                y_or_n = input(f'Попробовать еще раз? Y/N ')
                if y_or_n == 'Y' or y_or_n == 'y':
                    print(try_except.my_input())
                elif y_or_n == 'N' or y_or_n == 'n':
                    return f'Вы вышли\nИтоговый список - {self.my_list}'
                else:
                    return f'Вы вышли\nИтоговый список - {self.my_list}'
