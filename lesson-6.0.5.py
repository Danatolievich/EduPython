...
class Pen(Stationery):
    ...
    def draw(self):
        return f'У вас есть {self.title}. Используйте ручку для отрисовки'
...
class Pencil(Stationery):
    ...
    def draw(self):
        return f'У вас есть {self.title}. Используйте карандаш для отрисовки'
...
class Handle(Stationery):
    ...
    def draw(self):
        return f'У вас есть {self.title}. Используйте маркер для отрисовки'
